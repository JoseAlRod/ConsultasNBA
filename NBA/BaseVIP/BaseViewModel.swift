...
class BaseInteractor {
    ...
    internal weak var baseProvider: BaseProviderInputProtocol?
    required init(){}
}
...
class BaseCoordinator {
    static func coordinator<ViewModel: BaseViewModel,
                            ...
                            Provider: BaseProvider>(viewModel: ViewModel.Type, interactor: Interactor.Type, provider: Provider.Type) -> (viewModel: ViewModel, interactor: Interactor, provider: Provider) {
